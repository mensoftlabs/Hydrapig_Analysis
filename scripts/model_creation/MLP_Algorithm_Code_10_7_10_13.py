...
def main():
    ...
    df = pd.read_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\main\df_datos_7_13.xlsx")
    ...
    joblib.dump(best_mlp, r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\models\modelo_mlp_ganancia_peso_10-07_10-13.pkl")
    ...
    clustered_stats_detailed.to_csv(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\clustering\clustering_week_5.csv", index=False)
    ...
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\max\df_ganacia_peso_max_10-07_10-13.xlsx")
    ...
    print("Máximos, mínimos y medias del último cluster seleccionado:\n", df_resultado_final)
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\min\df_ganacia_peso_min_10-07_10-13.xlsx")
