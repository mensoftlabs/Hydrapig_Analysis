...
def main():
    ...
    df = pd.read_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\main\df_datos_30_6.xlsx")
    ...
    joblib.dump(best_mlp, r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\models\modelo_mlp_ganancia_peso_09-30_10-06.pkl")
    ...
    def clustering_with_detailed_stats(df, gain_column='ganancia_peso', min_size=5):
        ...
        cluster_stats['Week'] = 4  # Add Week column with value 1 for all rows
    ...
    clustered_stats_detailed.to_csv(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\clustering\clustering_week_4.csv", index=False)
    clustered_stats_detailed
    print("Media de variables desescaladas por cluster:\n", cluster_means_scaled)
    cluster_counts = df['cluster'].value_counts().sort_index()
    print("Número de datos por cluster:\n", cluster_counts)
    df_cluster_1 = df[df['cluster'] == 2]
    ...
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\max\df_ganacia_peso_max_09-30_10-06.xlsx")
    ...
    print("Máximos, mínimos y medias del último cluster seleccionado:\n", df_resultado_final)
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\min\df_ganacia_peso_min_09-30_10-06.xlsx")
