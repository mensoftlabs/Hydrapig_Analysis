...
def main():
    ...
    df = pd.read_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\main\df_datos_16_22.xlsx")
    ...
    joblib.dump(best_mlp, r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\models\modelo_mlp_ganancia_peso_09-16_09-22.pkl")
    ...
    clustered_stats_detailed.to_csv(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\clustering\clustering_week_2.csv", index=False)
    ...
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\max\df_ganacia_peso_max_09-16_09-22.xlsx")
    df_cluster_1 = df[df['cluster'] == 0]
    ...
    print("Máximos, mínimos y medias del último cluster seleccionado:\n", df_resultado_final)
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\min\df_ganacia_peso_min_09-16_09-22.xlsx")
