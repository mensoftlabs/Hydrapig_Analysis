...
def main():
    ...
    df = pd.read_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\main\df_datos_14_20.xlsx")
    ...
    joblib.dump(best_mlp, r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\models\modelo_mlp_ganancia_peso_10-14_10-20.pkl")
    ...
    def clustering_with_detailed_stats(df, gain_column='ganancia_peso', min_size=5):
        ...
        cluster_stats['Week'] = 5  # Add Week column with value 1 for all rows
    ...
    clustered_stats_detailed.to_csv(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\clustering\clustering_week_6.csv", index=False)
    ...
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\max\df_ganacia_peso_max_10-14_10-20.xlsx")
    ...
    print("Máximos, mínimos y medias del último cluster seleccionado:\n", df_resultado_final)
    if df_resultado_final is not None:
        df_resultado_final.to_excel(r"C:\Users\alvar\Documents\Projects\Hydrapig_Analysis\data\Processed\bodyweight\min\df_ganacia_peso_min_10-14_10-20.xlsx")
